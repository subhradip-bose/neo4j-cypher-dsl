...
final class InternalNodeImpl extends NodeBase<InternalNodeImpl> {
	...
	InternalNodeImpl(String primaryLabel,String alias, String... additionalLabels) {
		super(primaryLabel,alias,  additionalLabels);
	}
	...
	InternalNodeImpl(SymbolicName symbolicName, String primaryLabel,String alias,
		MapExpression properties, String... additionalLabels) {
		super(symbolicName, primaryLabel,alias,  properties, additionalLabels);
	}
