...
public abstract class NodeBase<SELF extends Node> extends AbstractNode implements Node {
	 ...
	 */
	protected NodeBase(String primaryLabel,String alias, String... additionalLabels) {

		this(null, primaryLabel,alias, null, additionalLabels);
	}
	...
	NodeBase(SymbolicName symbolicName, String primaryLabel,String alias,  MapExpression properties, String... additionalLabels) {

		this(symbolicName, assertLabels(primaryLabel, additionalLabels, alias), Properties.create(properties));
	}
	...
	private static List<NodeLabel> assertLabels(String primaryLabel, String[] additionalLabels,  String alias) {
		...
		labels.add(new NodeLabel(primaryLabel, alias));
