...
public interface StatementContext {
	...
	/**
	 * Resolves a {@link SymbolicName symbolic name} into a string: A symbolic name
	 * can be a placeholder without an actual value. In such cases a value is
	 * randomly generated and will stay constant for that name as long as the
	 * statement exists. In case the {@code symbolicName} has a constant value it
	 * will be returned,
	 *
	...
	/**
	 * Checks whether a given {@link SymbolicName symbolic name} has been resolved
	 * in this {@link StatementContext context}.
	 *
